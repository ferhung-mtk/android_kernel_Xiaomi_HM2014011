...
#define TSK_ACTIVE_MM 560 /* offsetof(struct task_struct, active_mm)	@ */
#define TSK_STACK_CANARY 608 /* offsetof(struct task_struct, stack_canary)	@ */
...
#define MM_CONTEXT_ID 448 /* offsetof(struct mm_struct, context.id.counter)	@ */
